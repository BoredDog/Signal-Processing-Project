...
% locating the hits
[peaks,indices]=findpeaks(flux,'MinPeakHeight',0.1,'MinPeakDistance',5);hit_times=time_axis_stft(indices);
...
% cutoffs for the groups
low_cut=6500; 
high_cut=9000;

% making lists for the 3 drums
group1=[]; 
group2=[]; 
group3=[];
