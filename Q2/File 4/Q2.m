...
% cutoffs for the 5 groups (added another one)
cut1=2700; 
cut2=4200; 
cut3=6000;
cut4=8200; % new split for super high stuff

% making lists for the 5 drums
group1=[]; 
group2=[]; 
group3=[];
group4=[]; 
group5=[]; % added group 5
...
for k=1:num_hits
    ...
    % sorting it out into 5 groups now
    if val<cut1
...
% writing the very high sounds
if ~isempty(group5)
    audiowrite('out5.wav',group5,fs);
    disp('saved out5.wav');
end